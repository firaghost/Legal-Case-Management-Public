            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
                        @if($caseTypeData)
                            <div>
                                <dt class="font-medium text-gray-500">Police Station</dt>
                                <dd class="text-gray-900">{{ $caseTypeData->police_station ?? '—' }}</dd>
                            </div>
                            <div>
                                <dt class="font-medium text-gray-500">Police File Number</dt>
                                <dd class="text-gray-900">{{ $caseTypeData->police_file_number ?? '—' }}</dd>
                            </div>
                        @endif
                        <div>
                            <dt class="font-medium text-gray-500">Court File Number</dt>
                            <dd class="text-gray-900">{{ $case->court_file_number ?? '—' }}</dd>
                        </div>
                        <div>
