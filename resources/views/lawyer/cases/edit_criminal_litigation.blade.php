<x-app-layout>
                ...
                <div class="relative px-8 py-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-white mb-1">Edit Criminal Litigation Case</h1>
    ...
    <form action="{{ route('lawyer.cases.update', $case) }}" method="POST" enctype="multipart/form-data" x-data="criminalLitigationForm()" x-init="init()">
        @csrf
        @method('PUT')
        @include('lawyer.cases.partials.criminal_form', [
            'case' => $case,
    ...
    @push('scripts')
    <script>
    function criminalLitigationForm() {
        return {
            form: {
