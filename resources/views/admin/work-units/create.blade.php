                ...
                <div class="relative px-8 py-8">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-white mb-1">Create Work Unit</h1>
                                <p class="text-white/90 text-lg">Add a new organizational team or department</p>
                            </div>
                        </div>
                ...
                <div class="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 px-8 py-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Configure the work unit name, code, and status</p>
                        </div>
                    </div>
                </div>
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.work-units.store') }}" class="space-y-8">
                        @csrf
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-6">
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input id="is_active" name="is_active" type="checkbox" class="sr-only peer" {{ old('is_active', true) ? 'checked' : '' }}>
