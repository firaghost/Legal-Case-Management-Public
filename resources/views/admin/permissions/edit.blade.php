                ...
                <div class="relative px-8 py-8">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-white mb-1">Edit Permission</h1>
                                <p class="text-white/90 text-lg">Modify permission: {{ $permission->name }}</p>
                            </div>
                        </div>
                ...
                <div class="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 px-8 py-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Update the permission name, group, and description</p>
                        </div>
                    </div>
                </div>
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.permissions.update', $permission) }}" class="space-y-8">
                        @csrf
                        @method('PUT')
