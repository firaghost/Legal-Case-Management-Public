<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Modern Page Header -->
            <div class="relative overflow-hidden bg-gradient-to-r from-orange-600 to-amber-600 dark:from-orange-800 dark:to-amber-800 rounded-3xl shadow-2xl mb-8">
                ...
                <div class="relative px-8 py-8">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-white mb-2">Labor Cases Report</h1>
                                <p class="text-orange-100 text-lg">Labor litigation analytics and performance tracking</p>
                            </div>
                        </div>
                ...
                <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Customize your labor cases report</p>
                        </div>
                    </div>
                </div>
                ...
                <form method="GET" class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="flex gap-3">
                                <input type="text" name="start_date" placeholder="Start Date" 
                                    class="datepicker flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400" 
                        ...
                        <div>
                            ...
                            <select name="branch_id" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                    ...
                    <div class="flex justify-end mt-8">
                        <button type="submit" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-200">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.207A1 1 0 013 6.5V4z"/>
                            </svg>
                            Apply Filters
                ...
                <div class="px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Download your labor cases report</p>
                        </div>
                        <div class="flex space-x-3">
                            <a href="{{ route('admin.reports.export', ['module'=>'labor'] + request()->all()) }}&format=pdf" 
                            ...
                            <a href="{{ route('admin.reports.export', ['module'=>'labor'] + request()->all()) }}&format=excel" 
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-1">Labor Cases Data</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Labor litigation tracking and performance analytics</p>
                        </div>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($cases as $case)
                                @php
                                    ...
                                    $claimed = $case->claimed_amount ?? $case->outstanding_amount;
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 dark:text-white">
                                            @if($claimed)
                                                <span class="font-medium">ETB {{ number_format($claimed, 2) }}</span>
                                            @else
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm space-y-1">
                                            <div class="text-gray-900 dark:text-white">
                                                @if($recovered)
                                                    <span class="font-medium">ETB {{ number_format($recovered, 2) }}</span>
                                                @else
                                            ...
                                            @if($performance > 0)
                                                <div class="flex items-center space-x-1">
                                                    <div class="w-16 bg-gray-200 dark:bg-gray-600 rounded-full h-1.5">
                                                        <div class="bg-gradient-to-r from-orange-500 to-amber-500 h-1.5 rounded-full" style="width: {{ min($performance, 100) }}%"></div>
                                                    </div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 dark:text-white">{{ $cf?->creator?->name ?? 'N/A' }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 dark:text-white">{{ $cf?->lawyer?->name ?? 'N/A' }}</div>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="9" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">No labor cases found</h3>
...
@section('title', 'Labor Litigation Cases Report')

@php
    // columns to display can be configured here if needed
@endphp
