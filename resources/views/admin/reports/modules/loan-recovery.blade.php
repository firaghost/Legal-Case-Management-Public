        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative px-8 py-8">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-white mb-2">Loan Recovery Report</h1>
                                <p class="text-emerald-100 text-lg">Comprehensive loan recovery tracking and performance analytics</p>
                            </div>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 mb-8">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Customize your loan recovery report parameters</p>
                </div>
                ...
                <form method="GET" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <input type="text" name="start_date" id="start_date" placeholder="Start Date" 
                                       class="datepicker w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white transition-colors" 
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="branch_id" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white transition-colors">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="period" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white transition-colors">
                                @foreach(['monthly'=>'Monthly','quarterly'=>'Quarterly','semi-annual'=>'Semi-Annual','9-month'=>'9-Month','annual'=>'Annual'] as $key=>$label)
                                    <option value="{{ $key }}" @selected(request('period',$key)==$key)>{{ $label }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end mt-8">
                        <button type="submit" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-200">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Download your loan recovery report</p>
                        </div>
                    </div>
                    <div class="flex gap-3">
                        <a href="{{ route('admin.reports.export', ['module'=>'loan-recovery'] + request()->all()) }}&format=pdf" 
                        ...
                        <a href="{{ route('admin.reports.export', ['module'=>'loan-recovery'] + request()->all()) }}&format=excel" 
            ...
            <!-- Loan Recovery Cases Data -->
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-1">Loan Recovery Cases</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Loan recovery tracking and performance analytics</p>
                        </div>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 dark:text-white">
                                            @if($claimed)
                                                <span class="font-medium text-emerald-600 dark:text-emerald-400">ETB {{ number_format($claimed, 2) }}</span>
                                            @else
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm space-y-2">
                                            <div class="text-gray-900 dark:text-white">
                                                @if($recovered)
                                                    <span class="font-medium text-emerald-600 dark:text-emerald-400">ETB {{ number_format($recovered, 2) }}</span>
                                                @else
                                            ...
                                            @if($performance > 0)
                                                <div class="flex items-center space-x-2">
                                                    <div class="w-20 bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                                                        <div class="bg-gradient-to-r from-emerald-500 to-teal-500 h-2 rounded-full" style="width: {{ min($performance, 100) }}%"></div>
                                                    </div>
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">No loan recovery cases found</h3>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white mt-1">
                                            @if($recovered)
                                                <span class="text-emerald-600 dark:text-emerald-400">ETB {{ number_format($recovered, 2) }}</span>
                                            @else
                                                <span class="text-gray-400">Not recovered</span>
                                            @endif
                                        </p>
