...
<head>
    <meta charset="utf-8">
    <title>Labor Litigation Cases Report - Legal Organization</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
            ...
            <tr>
                ...
                <td class="header-right-cell">
                    <div class="header-right">
                        <div class="report-title">Labor Cases Report</div>
                        <div class="report-subtitle">Comprehensive Labor Case Management Analysis</div>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="description-section">
        ...
        <p>This comprehensive report provides detailed information on all labor litigation cases handled by Legal Organization Legal Department. It includes plaintiff and defendant information, claimed and recovered amounts, case status, and associated branch and court details. This report is essential for HR compliance monitoring, legal performance review, and labor dispute management.</p>
    </div>
