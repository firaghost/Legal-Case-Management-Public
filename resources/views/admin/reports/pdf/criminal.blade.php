...
<head>
    <meta charset="utf-8">
    <title>Criminal Litigation Cases Report - Legal Organization</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
            ...
            <tr>
                ...
                <td class="header-right-cell">
                    <div class="header-right">
                        <div class="report-title">Criminal Cases Report</div>
                        <div class="report-subtitle">Comprehensive Criminal Case Management Analysis</div>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="description-section">
        ...
        <p>This comprehensive report provides detailed information on all criminal litigation cases handled by Legal Organization Legal Department. It includes police division references, prosecutor office details, charged persons, claimed amounts, recovery status, and associated branch and court information. This report is essential for compliance monitoring, case management, and performance tracking in criminal litigation matters.</p>
    </div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th>Prosecutor Office</th>
                <th>Charged Person(s)</th>
        ...
        @foreach($cases as $c)
            @php 
                $cf = $c->caseFile; 
                $claimed = is_numeric($c->claim_material_desc) ? $c->claim_material_desc : 0;
            ...
            <tr>
                ...
                <td>{{ $c->police_ref_no ?: 'N/A' }}</td>
                <td>{{ $c->prosecutor_ref_no ?: 'N/A' }}</td>
